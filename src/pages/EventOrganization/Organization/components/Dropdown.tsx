  ...
  return (
    <form className="max-w-sm mx-auto">
      ...
      <select
        ...
        {!isFetching && dataJoinedEvent?.map((org: any) => (
          <option key={org.id} value={org.idOrganization} selected={currentOrganization.idOrganization == org.idOrganization}>{org.nameOrganization}</option>
        ))}
      </select>
    </form>
  );
