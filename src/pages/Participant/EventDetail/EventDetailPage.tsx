...
const EventDetailPage = () => {
  ...
  return (
    privacy === SD_Privacy_Event.PRIVATE ? (
      <div className="px-8 md:px-40 py-10 bg-gray-100 overflow-hidden max-w-full w-full">Event is private</div>
    ) : (
      isFetching ? (
        <Loading />
      ) : (
        <div className="px-8 md:px-40 py-10 bg-gray-100 overflow-hidden max-w-full w-full">
          {/* Main Image Section */}
          ...
          <div className="flex flex-row w-full md:w-[75vw] mx-auto bg-white p-8 shadow-lg rounded-lg mt-8 overflow-hidden max-w-full overflow-x-auto">
            ...
            <div className="flex-col flex w-5/6 ">
              ...
              <div className="flex mb-6 bg-gray-100 rounded-lg p-4 shadow-sm">
          ...
          {isTicketOrderVisible && (
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm transition-all">
              <div className="bg-white p-6 rounded-lg shadow-xl max-w-lg w-[90%]">
