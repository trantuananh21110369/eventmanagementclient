  ...
  return (
    <header className={`bg-primary p-3 ${className}`}>
      <div className="flex flex-col sm:flex-row justify-between sm:ml-0">
        ...
        <div className="flex items-center w-10 sm:w-auto sm:flex">
        ...
        <nav className="flex items-center sm:ml-auto w-full sm:w-auto justify-between mt-2 sm:mt-0 sm:flex-row flex-col">
          <div className="flex items-center sm:space-x-4 space-x-2 w-full justify-between">
            {/* Mode Theme và Avatar cùng hiển thị trên một hàng */}
