        ...
        {dataTickets.map((ticket, index) => (
          <div key={index} className="max-w-md mx-auto p-4 bg-white border border-gray-300 rounded-lg shadow-lg">
            ...
            <div className="flex justify-between items-center mb-2 gap-3">
              <div>
                <h2 className="text-sm font-semibold text-gray-800 w-[200px]">{ticket?.nameTicket}</h2>
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="px-3">{quantities.find(q => q.TicketId === ticket.idTicket)?.quantity || 0}</span>
                <button
